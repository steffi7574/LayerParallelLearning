...
DEPS = braid_wrapper.hpp hessianApprox.hpp layer.hpp linalg.hpp network.hpp util.hpp config.hpp
OBJ= main.o util.o hessianApprox.o layer.o linalg.o network.o braid_wrapper.o config.o
